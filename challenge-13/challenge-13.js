(function (){
  ...
  */
   var norte = ['Para', 'Amazonas', 'Roraima']
   console.log( '\nAlguns Estados do Brasil:' +brasil.unshift(norte)+'');
  // ?
  ...
  */
  // ?
  var nordeste = ['Maranhao', 'Ceara', 'Piaui', 'Bahia', 'Sergipe', 'Alagoas', 'Pernambuco', 'Paraíba', 'Rio Grande do Norte'];
